...
請按照 link:kvm-host-configuration-and-preparation-checklist.html["主辦單位準備清單"] 操作,並查看 link:reference_chk_deploy_req_info.html["部署實用程式安裝"] 和 link:reference_chk_select_req_info.html["ONTAP Select安裝"] 所需的資訊以了解更多資訊。
